...
public interface BookingService {
    ...
    List<BookingDto> getAllBooksByUser(Long userId, String state, int from, int size);

    List<BookingDto> getAllBooksByOwner(Long userId, String state, int from, int size);
}
