...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findALLUserBookings(User user, Pageable pageable);
     ...
     * querry- + status
     */
    List<Booking> findAllByBookerAndStatusEqualsOrderByStartDesc(User user, Status state, Pageable pageable);

    /**
     * all owner
     */
    @Query("select b from Booking b join Item i on b.item.id = i.id where i.ownerId =?1 order by b.start DESC")
    List<Booking> findAllByBookerAll(long owner, Pageable pageable);
    ...
    List<Booking> findCurrentBookingsByOwner(long orderId, LocalDateTime start, LocalDateTime end, Pageable pageable);
    ...
    @Query("select b from Booking as b  join Item as i on b.item.id = i.id " +
            ...
            "order by b.start DESC")
    List<Booking> findPastBookingsByOwner(long orderId, LocalDateTime end, Pageable pageable);
    ...
    @Query("select b from Booking as b inner join Item as i on b.item.id = i.id " +
            ...
            "order by b.start DESC")
    List<Booking> findFutureBookingsByOwner(long orderId, LocalDateTime start, Pageable pageable);
    ...
    @Query("select b from Booking as b inner join Item as i on b.item.id = i.id " +
            ...
            "order by b.start DESC")
    List<Booking> findAllByBookerByStatusOwner(long orderId, Status state, Pageable pageable);
